class upload{
  constructor(){
    ...
    this.filename="file";
    this.selectBtnStyle="width:100px;height:50px;border-radius:5px;background:#444;color:#ffffff";
    this.selectBtnCon="请选择";

    this.upBtnStyle="width:100px;height:50px;border-radius:5px;background:#ccc;clear:both;"
    this.upBtnCon="点击上传";

    this.pStyle="width:500px;";

    this.listStyle="width:150px;height:150px;float:left;border:1px solid #ccc;padding:5px;";    this.progressStyle="width:100%;height:5px;position:absolute;bottom:0;left:0;"
 ...
 createSelect(parent,selectBtn,callback){
     ...
     file.style.cssText="opacity:0;position:absolute;z-admin:1;height:100%;width:100%;left:0;top:0;";
